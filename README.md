...
Workflow выбирает на каждую дату один псевдослучайный двадцатиминутный слот между 06:00 и 10:00 по времени Asia/Qyzylorda. Только выбранный слот выполняет вход и получает награду; остальные проверки завершаются до загрузки кода и запуска браузера. GitHub может начать запланированное задание на несколько минут позже.
